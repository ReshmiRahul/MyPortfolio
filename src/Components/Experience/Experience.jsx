            ...
            <div className='text-white bg-black shadow-xl bg-opacity-30 rounded-lg p-4 md:mb-4 md:mt-28 mt-4 md:mx-6'>
                ...
                <div className='text-white bg-black shadow-xl bg-opacity-30 rounded-lg p-4 md:mb-4 md:mx-6'>
                    <div className='flex gap-3 py-4 md:ml-20 md:mt-0 flex-col'>
                        ...
                        <p className='text-sm md:text-md leading-tight text-yellow-300'>
                        &#9733; Developed cloud-native solutions for embedded systems, enhancing network efficiency and scalability through full-stack development.
                        </p>
                        <p>
                        Developed cloud-native full-stack solutions using Python for back-end services and Angular/Vue.js for front-end development. Designed and implemented responsive, user-friendly interfaces while ensuring seamless integration and optimal performance. Contributed to all stages of the development lifecycle, including Agile processes, testing, and troubleshooting.
                        </p>
                    </div>
                </div>
